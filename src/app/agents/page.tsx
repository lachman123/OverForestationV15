    ...
    <main className="">
      <div className="z-10 max-w-lg w-full items-center justify-between font-mono text-sm lg:flex">
        <Narration
          ...
          captionPrompt={`You are provided with a world state and an array of agents performing tasks to make changes to this world state. Write a short script that narrates an interview with Gordon Cadwell, who is one of the chairs on the board of directors of the Forestry project in Canada, whos at his wits end, borderline going crazy, and hes talking about how annoying it is dealing with the struggles and issues that arise throughout the project. The man can can make jokes about his struggles which should be satiric, funny, edgy or dark humor jokes to match his personality. Please ensure that they are still respectful and considerate, avoiding any content that might be overly offensive or harmful. Do not refer to the agents as ‘agents’, refer to them by the name of the group they represent, or make up a persons name for example: ‘John Smith from Saskatoon Forestry Management’. Narrate the interview as lines of dialogue between Gordon and the interviewer. The interviewer shouldnt reply to every sentence from Gordon, instead should ask questions that would allow Gordon to tell a captivating story, something engaing or make a joke. Place each item of dialogue on a new line. Each line should be in the format "Speaker: Dialogue". Do not include any other text or explanation.`}
