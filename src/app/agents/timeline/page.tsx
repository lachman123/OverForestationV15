...
const agentGoal =
  "Build and expand a forestation project in Canada's northern short grasslands, with the goal of supplying the worlds construction timber by 2060, whilst resolving unexpected conflicts and events between agents";
    ...
    <main className="">
      <div className="z-10 max-w-lg w-full items-center justify-between font-mono text-sm lg:flex">
        <Narration
          ...
          Write a short script that narrates a stand-up comedian telling jokes in front of a live audience about the interactions between agents and their struggles with the project. 
          The jokes must be satire, funny, edgy or dark humor jokes. Please ensure that they are still respectful and considerate, avoiding any content that might be overly offensive or harmful. 
          Do not refer to the agents as ‘agents’, refer to them by the name of the group they represent, or make up a persons name eg ‘John Smith from Saskatoon Forestry Management’. 
          Narrate the comedy show as lines of dialogue by the comedian and the audience, with some heckles from the audience making snarky comments. Some jokes can have a longer story that builds up to the joke. 
          When the comedian tells a funny joke the audience can have a reaction such as laughing, booing silence etc, depending on how appropriate the joke was or if the audience is offended. 
          Place each item of dialogue on a new line. Each line should be in the format "Speaker: Dialogue". Do not include any other text or explanation.`}
